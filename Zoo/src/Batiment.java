...
public class Batiment extends Endroit {
	private ArrayList<Animal> listAnimal = new ArrayList<Animal>();// initialisation de l'attribut 'listAnimal' qui se trouve dans un batiment
	...
	public Batiment(String newNom, long newSurface, int newNbAnimauxMax, ArrayList<Animal> newListAnimal) {
